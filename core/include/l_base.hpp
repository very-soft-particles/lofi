...
#define MEM_FILL_ONES_STRUCT(ptr) MEM_ZERO((ptr), sizeof(*(ptr)))
#define MEM_FILL_ONES_ARRAY(ptr) MEM_ZERO((ptr), sizeof(ptr))
#define MEM_FILL_ONES_COUNT(ptr, count) MEM_ZERO((ptr), sizeof(*(ptr))*(count))
